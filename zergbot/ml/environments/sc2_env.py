...
class Sc2Env:
    ...
    """
    def __init__(self, bot_name: str, game_map: str, opponent: str, agent: str, agent_build: str, train=True):
        self.agent = agent
    ...
    def run(self):
        try:
            bot1 = Bot(Race.Zerg, HarvesterBot(self.agent, self.agent_build, self.train))
